...
export default function ServiceCard({
  ...
  return (
    <div
      className={`w-full rounded-lg overflow-hidden shadow-lg bg-black/20 hover:shadow-2xl hover:shadow-white/10 transition-all duration-300 hover:scale-105 hover:-translate-y-1`}
    >
