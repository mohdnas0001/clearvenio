  ...
  return (
      ...
      <div className="relative z-20 px-4 md:px-8 lg:px-16 py-20 md:py-32">
        <div className="max-w-4xl">
          ...
          <p className="text-base md:text-lg text-gray-300 mb-8 max-w-2xl leading-relaxed animate-fadeInUp" style={{animationDelay: "0.2s"}}>
            Big ideas are powerful – they get people thinking and dreaming, but if they fail to move, they don&apos;t change anything.
          </p>

          <button className="px-8 py-3 bg-black text-white rounded-full font-semibold hover:bg-gray-800 hover:scale-105 transition-all duration-200 border border-gray-700 animate-scaleIn" style={{animationDelay: "0.3s"}}>
            Work with Us
          </button>
        </div>
      </div>
